...
[**Live Demo**](https://xjzsq.github.io/mc-optimal-enchanting-order-calculator/)
...
- **Enchantable item selection**: Covers swords, bows, crossbows, tridents, pickaxes, axes, shovels, hoes, helmets, chestplates, leggings, boots, and shields.
- **Initial enchantment configuration**: Set existing enchantments and their levels on the item, as well as the current prior work (times used on anvil).
...
- **Ignore prior work mode**: Optionally ignore the "Too Expensive" (39-level) limit to calculate the theoretical optimal order.
...
- **Bilingual support**: The interface supports both Chinese and English; switch between languages as preferred.

## Getting Started

### Use Online

Visit directly: [https://xjzsq.github.io/mc-optimal-enchanting-order-calculator/](https://xjzsq.github.io/mc-optimal-enchanting-order-calculator/)
